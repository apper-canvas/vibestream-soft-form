...
import { setProfile, clearProfile, setLoading } from "@/store/slices/userSlice";
...
export default function Root() {
  ...
  const handleAuthSuccess = (user) => {
    if (user) {
      dispatch(loginSuccess({ token: 'authenticated' }));
  ...
  return (
    <AuthContext.Provider value={{ logout: logoutUser, isInitialized: authInitialized }}>
      <Outlet />
